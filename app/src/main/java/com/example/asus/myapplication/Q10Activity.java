...
public class Q10Activity extends AppCompatActivity {
    ...
    private int mQuestionNumber = 43;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionView = (TextView)findViewById(R.id.soal10);
        mButtonChoice1 = (Button)findViewById(R.id.ans10A);
        mButtonChoice2 = (Button)findViewById(R.id.ans10B);
        mButtonChoice3 = (Button)findViewById(R.id.ans10C);
        mButtonChoice4 = (Button)findViewById(R.id.ans10D);
        mButtonChoice5 = (Button)findViewById(R.id.ans10E);
        mButtonNext = (Button)findViewById(R.id.next10);
        ...
        s9 = (ImageView)findViewById(R.id.soal9);
        s10 = (ImageView)findViewById(R.id.soal110);
    ...
    public void next(View view){
        Bundle bundle = getIntent().getExtras();
        mUserid = bundle.getString("idstring10");
        Intent i = new Intent(this, FinishActivity.class);
        i.putExtra("idstringfinish",mUserid);
        i.putExtra("score10", mScore);
        startActivity(i);
