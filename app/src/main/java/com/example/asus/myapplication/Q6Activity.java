...
public class Q6Activity extends AppCompatActivity {
    ...
    private int mQuestionNumber = 23;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionView = (TextView)findViewById(R.id.soal6);
        mButtonChoice1 = (Button)findViewById(R.id.ans6A);
        mButtonChoice2 = (Button)findViewById(R.id.ans6B);
        mButtonChoice3 = (Button)findViewById(R.id.ans6C);
        mButtonChoice4 = (Button)findViewById(R.id.ans6D);
        mButtonChoice5 = (Button)findViewById(R.id.ans6E);
        mButtonNext = (Button)findViewById(R.id.next6);
    ...
    public void next(View view){
        Bundle bundle = getIntent().getExtras();
        mUserid = bundle.getString("idstring6");
        Intent i = new Intent(this, Q7Activity.class);
        i.putExtra("idstring7",mUserid);
        i.putExtra("score6", mScore);
        startActivity(i);
