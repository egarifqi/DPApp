...
public class Q4Activity extends AppCompatActivity {
    ...
    private int mQuestionNumber = 17;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionView = (TextView)findViewById(R.id.soal4);
        mButtonChoice1 = (Button)findViewById(R.id.ans4A);
        mButtonChoice2 = (Button)findViewById(R.id.ans4B);
        mButtonChoice3 = (Button)findViewById(R.id.ans4C);
        mButtonChoice4 = (Button)findViewById(R.id.ans4D);
        mButtonChoice5 = (Button)findViewById(R.id.ans4E);
        mButtonNext = (Button)findViewById(R.id.next4);
    ...
    public void next(View view){
        Bundle bundle = getIntent().getExtras();
        mUserid = bundle.getString("idstring4");
        Intent i = new Intent(this, Q5Activity.class);
        i.putExtra("idstring5",mUserid);
        i.putExtra("score4", mScore);
        startActivity(i);
