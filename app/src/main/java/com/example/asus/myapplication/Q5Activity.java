...
public class Q5Activity extends AppCompatActivity {
    ...
    private int mQuestionNumber = 21;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionView = (TextView)findViewById(R.id.soal5);
        mButtonChoice1 = (Button)findViewById(R.id.ans5A);
        mButtonChoice2 = (Button)findViewById(R.id.ans5B);
        mButtonChoice3 = (Button)findViewById(R.id.ans5C);
        mButtonChoice4 = (Button)findViewById(R.id.ans5D);
        mButtonChoice5 = (Button)findViewById(R.id.ans5E);
        mButtonNext = (Button)findViewById(R.id.next5);
    ...
    public void next(View view){
        Bundle bundle = getIntent().getExtras();
        mUserid = bundle.getString("idstring5");
        Intent i = new Intent(this, Q6Activity.class);
        i.putExtra("idstring6",mUserid);
        i.putExtra("score5", mScore);
        startActivity(i);
