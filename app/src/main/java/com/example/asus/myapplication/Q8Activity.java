...
public class Q8Activity extends AppCompatActivity {
    ...
    private int mQuestionNumber = 31;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionView = (TextView)findViewById(R.id.soal8);
        mButtonChoice1 = (Button)findViewById(R.id.ans8A);
        mButtonChoice2 = (Button)findViewById(R.id.ans8B);
        mButtonChoice3 = (Button)findViewById(R.id.ans8C);
        mButtonChoice4 = (Button)findViewById(R.id.ans8D);
        mButtonChoice5 = (Button)findViewById(R.id.ans8E);
        mButtonNext = (Button)findViewById(R.id.next8);
    ...
    public void next(View view){
        Bundle bundle = getIntent().getExtras();
        mUserid = bundle.getString("idstring8");
        Intent i = new Intent(this, Q9Activity.class);
        i.putExtra("idstring9",mUserid);
        i.putExtra("score8", mScore);
        startActivity(i);
