...
public class Q2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionView = (TextView)findViewById(R.id.soal2);
        mButtonChoice1 = (Button)findViewById(R.id.ans2A);
        mButtonChoice2 = (Button)findViewById(R.id.ans2B);
        mButtonChoice3 = (Button)findViewById(R.id.ans2C);
        mButtonChoice4 = (Button)findViewById(R.id.ans2D);
        mButtonChoice5 = (Button)findViewById(R.id.ans2E);
        mButtonNext = (Button)findViewById(R.id.next2);
    ...
    public void next(View view){
        Bundle bundle = getIntent().getExtras();
        mUserid = bundle.getString("id2");
        Intent i = new Intent(this, Q3Activity.class);
        i.putExtra("idstring3",mUserid);
        i.putExtra("score2", mScore);
        startActivity(i);
