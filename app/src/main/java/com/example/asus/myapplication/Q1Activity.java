...
public class Q1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionView = (TextView) findViewById(R.id.soal1);
        mButtonChoice1 = (Button) findViewById(R.id.ans1A);
        mButtonChoice2 = (Button) findViewById(R.id.ans1B);
        mButtonChoice3 = (Button) findViewById(R.id.ans1C);
        mButtonChoice4 = (Button) findViewById(R.id.ans1D);
        mButtonChoice5 = (Button) findViewById(R.id.ans1E);
        mButtonNext = (Button) findViewById(R.id.next1);
        ...
        //mUserid = bundle.getString("idstring"); //
        ...
        //Ambil Soal dan pilihan jawaban dan kunci jawaban ke library
    ...
    public void next(View view) {
        Bundle bundle = getIntent().getExtras();
        mUserid = bundle.getString("idstring");
        Intent i = new Intent(this, Q2Activity.class);
        i.putExtra("id2", mUserid);
        i.putExtra("score1", mScore);
        startActivity(i);
