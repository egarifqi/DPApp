...
public class Q7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionView = (TextView)findViewById(R.id.soal7);
        mButtonChoice1 = (Button)findViewById(R.id.ans7A);
        mButtonChoice2 = (Button)findViewById(R.id.ans7B);
        mButtonChoice3 = (Button)findViewById(R.id.ans7C);
        mButtonChoice4 = (Button)findViewById(R.id.ans7D);
        mButtonChoice5 = (Button)findViewById(R.id.ans7E);
        mButtonNext = (Button)findViewById(R.id.next7);
    ...
    public void next(View view){
        Bundle bundle = getIntent().getExtras();
        mUserid = bundle.getString("idstring7");
        Intent i = new Intent(this, Q8Activity.class);
        i.putExtra("idstring8",mUserid);
        i.putExtra("score7", mScore);
        startActivity(i);
