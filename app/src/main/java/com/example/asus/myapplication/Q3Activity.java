...
public class Q3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionView = (TextView)findViewById(R.id.soal3);
        mButtonChoice1 = (Button)findViewById(R.id.ans3A);
        mButtonChoice2 = (Button)findViewById(R.id.ans3B);
        mButtonChoice3 = (Button)findViewById(R.id.ans3C);
        mButtonChoice4 = (Button)findViewById(R.id.ans3D);
        mButtonChoice5 = (Button)findViewById(R.id.ans3E);
        mButtonNext = (Button)findViewById(R.id.next3);
    ...
    public void next(View view){
        Bundle bundle = getIntent().getExtras();
        mUserid = bundle.getString("idstring3");
        Intent i = new Intent(this, Q4Activity.class);
        i.putExtra("idstring4",mUserid);
        i.putExtra("score3", mScore);
        startActivity(i);
